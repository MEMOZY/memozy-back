...
public class TemporaryMemoryStoreImpl implements TemporaryMemoryStore {
    ...
    public void remove(String sessionId) {
        memoryRedisTemplate.delete(PREFIX + sessionId);
    }
}